...
println("@time nodes_BigFloat132, weights_BigFloat132 = custom_gauss_quad_fn(BigFloat, which_f, n);")
...
println("@time nodes, weights = custom_gauss_quad_all_fn(which_f, n);")
...
println("@time nodes, weights = custom_gauss_quad_all_fn(which_f, n, true);")
